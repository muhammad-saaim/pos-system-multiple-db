...
return [
    ...
    */
    'connections' => [
        ...
        'mysql_master' => [
            'driver' => 'mysql',
            'url' => env('DB_URL_MASTER'),
            'host' => env('DB_HOST_MASTER', '127.0.0.1'),
            'port' => env('DB_PORT_MASTER', '3306'),
            'database' => env('DB_DATABASE_MASTER', 'pos_master'),
        ...
        'mysql_slave' => [
            'driver' => 'mysql',
            'url' => env('DB_URL_SLAVE'),
            'host' => env('DB_HOST_SLAVE', '127.0.0.1'),
            'port' => env('DB_PORT_SLAVE', '3306'),
            'database' => env('DB_DATABASE_SLAVE', 'pos_slave'),
            'username' => env('DB_USERNAME_SLAVE', 'root'),
